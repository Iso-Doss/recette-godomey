...
if (empty($_GET['id'])) {
    $message = "La recette que vous souhaitez mettre a jour n'existe pas.";
...
if (empty($recette)) {
    ...
    $message = "La recette que vous souhaitez mettre a jour ne vous appartient pas.";
    header('location:index.php?page=mes-recettes&erreur=' . $message);
}
...
<div class="row d-flex align-items-center">
    <div class="col-md-9">
        <h3>
            Mise a jour de la recette <?= $recette['nom']; ?>
        </h3>
    </div>
...
<div class="row g-3 d-flex justify-content-center">
    <form class="col-md-6" action="index.php?page=traitement-modifier-recette&id=<?= $_GET['id'];?>" method="POST" novalidate enctype="multipart/form-data">
        <p class="text-center">
